          ...
          <div className="col-lg-6 mx-auto">
            ...
            <div className="bg-primary-9 py-10 px-3 px-lg-30 mb-20 rounded-2">
              ...
              <div className="mb-10">
                ...
                <button
                  type="button"
                  className="btn btn-success w-100 rounded-4 fw-bolder mb-5 py-2"
                >
                  <img
                    src="https://s3-alpha-sig.figma.com/img/d7bc/c6e0/6c2c184012a38a8dbf129cae0d16b308?Expires=1742169600&Key-Pair-Id=APKAQ4GOSFWCW27IBOMQ&Signature=garJ2hqup~CW0U1f8Xvz~FF3j2Flt9qo-lCZ-HJTxH28v-4qaHLxIuwSqW6pixqqvnDGI4WlOpXcJCZ9L~HV9wEWU5AwO-FxiDY9OYepQd5v5Y1ePDw8rWSwa71mZ1aUCy5trO2CL1zb8KPzC~YUoiQnq0~PnZ~TPA3khwqZC5wqtQA6eZcRpCzh0UtBRpoQcQszYDwqW6KRMugOhSbZsDtHr-TyUihwTGettAOZsd09W3vhX0MESc6hn2343DYlYKhXvnUqTmfS4zizzUP6-XwjcgBcJf7iuXNXgB2qvvxhG8CfK3HL1tPLEhcLCyhgd-gcmqZySIPSmm9ul~lEGg__"
                    alt="fb"
                    className="me-2 "
                    style={{ width: "24px", height: "24px" }}
                  />
                ...
                <button
                  type="button"
                  className="btn btn-light w-100 rounded-4 fw-bolder mb-5 py-2"
                >
                  <img
                    src="https://s3-alpha-sig.figma.com/img/fd6c/8c0e/a0b4a34ebb9bf63926751b620f06967d?Expires=1742169600&Key-Pair-Id=APKAQ4GOSFWCW27IBOMQ&Signature=DdqtMYEPUzvRinbJpNKtqUH54ryvPzKjf~43En4Qvdmd4dsT0SS1zcSsF9WX-~QFq33oSMVTd50yS5E9~u3xyP94SBfXG3QG5A0JhqDjzN5ucNJRFMz-ZAOYaGhUsojsv1H1rEX7ucvvyq0y7bMf5XTY7xmVlkE9NhfGqMjqMLlZelYf974t-9dZ31UcK3eM9qOflexidyopiKerC5TtQ3sC~zx6ZZwqCe4UBn-Ym0spUApoA5e2azl-JUfrWs9Ifd1hl-gemT9wjikETsI3LlDDYF7fTZJ3h-YPdbfBiji~HXDoMohT1EHp5cJRJW9ePp3wCrQ-XBdxWFrUXJygtQ__"
                    alt="fb"
                    className="me-2 "
                    style={{ width: "24px", height: "24px" }}
                  />
              ...
              <form className="" onSubmit={handleSubmit(login)}>
                ...
                <div>
                  <button
                    type="submit"
                    className="btn btn-primary form-control py-3 mb-5"
                  >
                    登入
                  </button>
                  <p className="text-center">
                    登入後即代表你同意
                    <span className="border-bottom">服務條款</span>及
                    <span className="border-bottom">隱私權政策</span>
                  </p>
                </div>
              </form>
            </div>
