...
export default function PaymentComplete () {
  ...
  const { projectTitle , productTitle , totalMoney , goalMoney , type , bankCode , accountNumber , paymentCode } = state.state
        ...
        <div className="container" data-aos="zoom-in" data-aos-delay="200">
          <div className="thanks-wrapper w-lg-50 w-md-75 w-100">
            <div className="thanks-content">
              ...
              {/* <!-- 確認方案 --> */}
              <h1 className="bi bi-check-circle py-4" style={{color: "lightgreen"}} data-aos="zoom-out-up" data-aos-delay="300">
                { type === 0 ? ("付款成功") : ("訂單成立") }
              </h1>
                ...
                <>
                  ...
                  <section>
                    <div className="d-flex align-items-center justify-content-center mb-2">
                      <span className="fs-7 fw-bold text-warning me-1">感謝您</span><p className="mb-0" style={{lineHeight: "20px"}}>的贊助！</p>
                    </div>
                    <div className="d-flex align-items-center justify-content-center">
                      <span className="fs-7 fw-bold text-warning">因為您</span><p className="mb-0" style={{lineHeight: "20px"}}>，我們的目標前進了一大步！</p>
                    </div>
                  </section>

                  {/* <!-- 進度條區塊 --> */}
                  <section className="thanks-progress-wrapper d-flex align-items-center w-md-75 w-100 mx-auto">
                    <div className="progress bg-primary-8" style={{ height: 8 }}>
                      <div
                ...
                <>
                  ...
                  <section>
                    <h4 className="fs-sm-7 fs-sm text-danger">
                      ...
                      { type === 2 && ("請於期限內至四大超商之多媒體機台(ibon、FamiPort、OK-go、Life-ET)列印繳費單至超商櫃台以現金繳費。")}
                    </h4>
                    <div className="row justify-content-center text-start">
                      <div className="col-xxl-6 col-xl-8 col-lg-10 col-sm-8 col-10 mb-2">
                        { type === 1 && (<>
                          <p className="fs-md-6 fs-7 mb-0">銀行代碼：{bankCode}</p>
                          <p className="fs-md-6 fs-7 mb-0">帳號：{accountNumber}</p>
                        </>)}
                        { type === 2 && (
                          <p className="fs-md-6 fs-7 mb-0">繳費代碼：{paymentCode}</p>
                        )}
                      </div>
                    </div>
                    <h4 className="fs-sm text-danger">*繳費期限：{paymentDeadline.toLocaleString("sv")}</h4>
