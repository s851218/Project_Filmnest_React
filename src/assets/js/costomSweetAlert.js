...
export const CheckModal = Swal.mixin({
  ...
  customClass: {
    confirmButton: "btn btn-primary-1 border-white px-8 py-3 me-2 fw-bolder",
    cancelButton: "btn btn-primary-0 border-white px-8 py-3 ms-2 fw-bolder",
    container: "",
...
export const AdminCheckModal = Swal.mixin({
  ...
  heightAuto: false, // 取消預設自適應高度
  customClass: {
    confirmButton: "btn btn-outline-primary-10 border-primary-10 px-8 py-3 me-2 fw-bolder",
    cancelButton: "btn btn-outline-primary-10 border-primary-10 px-8 py-3 ms-2 fw-bolder",
    container: "",
