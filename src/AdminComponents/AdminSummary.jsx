    ...
    <div className="container mb-6 mb-lg-15">
      ...
      <div className="summary">
        <div className="item shadow ">
          <img src="fundsRaisedIcon.png" className="bg-primary-5" alt="fundsRaisedIcon" />
          <div>
        ...
        <div className="item shadow">
          <img src="watchNumIcon.png" className="bg-primary-5" alt="watchNumIcon" />
          <div>
        ...
        <div className="item shadow">
          <img src="projectsNumIcon.png" className="bg-primary-5" alt="projectsNumIcon" />
          <div>
        ...
        <div className="item shadow">
          <img src="collectNumIcon.png" className="bg-primary-5" alt="collectNumIcon" />
          <div>
            <h3 className="fs-sm mb-0 text-primary-6">collectNumIcon</h3>
            <p className="fs-md-6 fs-7 fw-bolder mb-0">672</p>
          </div>
        </div>
        <div className="item shadow">
          <img src="watchTimeIcon.png" className="bg-primary-5" alt="watchTimeIcon" />
          <div>
        ...
        <div className="item shadow">
          <img src="commitNumIcon.png" className="bg-primary-5" alt="commitNumIcon" />
          <div>
