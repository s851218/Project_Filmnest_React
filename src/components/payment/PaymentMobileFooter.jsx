      ...
      <>
        <footer className="checkout-footer d-lg-none d-block p-4 bg-primary-8 fixed-bottom">
          ...
          <div className="d-flex justify-content-between align-items-center flex-wrap gap-3">
            <button type="button" className="btn btn-secondary btn-base" onClick={() => handleOpenModal("check")}>
              查看訂單
            </button>
            <div className="d-flex align-items-center gap-3 justify-content-between">
              <p className="total-amount fs-7 mb-0">NT$ {totalPrice.toLocaleString()}</p>
              <button type="button" className="btn btn-primary btn-base ms-auto" onClick={handleFormsSubmit}>確認付款</button>
            </div>
          </div>
        </footer>
