        ...
        <div className="container">
          ...
          <div className="collapse navbar-collapse text-white">
            <div className="p-0 me-12 dropdown nav-item">
              <button
                className="btn btn-outline-light border-0 fw-bolder dropdown-toggle"
                type="button"
              ...
              <ul className="dropdown-menu py-0">
                <li>
                  <Link
                    className="btn btn-outline-secondary text-white border-0 w-100 d-flex align-items-center"
                    to="/projectExplore"
            ...
            <div className="ms-auto d-flex flex-column flex-lg-row align-items-center">
              {profile.token ? (
                <>
                  <div className="collapse navbar-collapse text-white">
                    <div className="p-0 me-8 dropdown nav-item">
                      <button
                        className="btn btn-outline-secondary text-white border-0 fw-bolder"
                        type="button"
                        data-bs-toggle="dropdown"
                        aria-expanded="false"
                      >
                ...
                <NavLink
                  to="/login"
                  className="btn btn-outline-light fw-bolder py-3 px-5 me-8"
                >
                  登入 / 註冊
                </NavLink>
              )}
              ...
              <NavLink
                to="/aboutProposal"
                className="btn btn-outline-light fw-bolder py-3 px-5 ms-8"
              >
                我要提案
              </NavLink>
            </div>
