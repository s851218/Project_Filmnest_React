        ...
        <div className="container">
          ...
          <div className="ms-auto d-flex align-items-center">
            {profile.token ? (
              <NavLink
                to="/personalCenter"
                className="btn btn-outline-light fw-bolder py-1 px-1 me-3 border-0"
              >
              ...
              <NavLink
                to="/login"
                className="btn btn-outline-light fw-bolder py-3 px-5 me-3"
              >
                登入 / 註冊
              </NavLink>
            )}
            <div
              className="border-start border-white mx-3"
              style={{ height: "20px" }}
            ></div>
            <NavLink
              to="/aboutProposal"
