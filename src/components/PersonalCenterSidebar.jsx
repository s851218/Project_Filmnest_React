      ...
      <div className="d-none d-lg-block">
        <nav>
          ...
          <ul className="list-unstyled d-flex flex-column">
            <li className="mb-3">
              <NavLink to="/personalCenter/profile" className="btn btn-outline-light border-0 py-3 px-5 rounded-3 d-flex align-items-center">
                <span className="material-symbols-outlined fs-7 me-3">manage_accounts</span>
                <span>個人資料</span>
              </NavLink>
            </li>
            <li className="mb-3">
              <NavLink to="/personalCenter/favoriteProject" className="btn btn-outline-light border-0 py-3 px-5 rounded-3 d-flex align-items-center">
            ...
            <li className="mb-3">
              <NavLink to="/personalCenter/favoriteVideo" className="btn btn-outline-light border-0 py-3 px-5 rounded-3 d-flex align-items-center">
                <span className="material-symbols-outlined fs-7 me-3">movie</span>
                <span>收藏影音</span>
              </NavLink>
            </li>
            <li className="mb-3">
              <NavLink to="/personalCenter/viewRecords" className="btn btn-outline-light border-0 py-3 px-5 rounded-3 d-flex align-items-center">
                <span className="material-symbols-outlined fs-7 me-3">subscriptions</span>
                <span>觀看紀錄</span>
              </NavLink>
            </li>
            <li className="mb-3">
              <NavLink to="/" className="btn btn-outline-light border-0 py-3 px-5 rounded-3 d-flex align-items-center">
      ...
      <div className="container d-lg-none">
        <div className="d-flex justify-content-between align-item-center d-lg-none mb-3">
          ...
          <ul className="dropdown-menu">
            <li className="mb-3">
              <NavLink to="/personalCenter/profile" className="btn btn-outline-light border-0 rounded-3 d-flex align-items-center">
                <span className="material-symbols-outlined fs-7 me-3">manage_accounts</span>
                <span>個人資料</span>
              </NavLink>
            </li>
            <li className="mb-3">
              <NavLink to="/personalCenter/favoriteProject" className="btn btn-outline-light border-0 rounded-3 d-flex align-items-center">
                <span className="material-symbols-outlined fs-7 me-3">favorite</span>
                <span>收藏專案</span>
              </NavLink>
            </li>
            ...
            <li className="mb-3">
              <NavLink to="/personalCenter/favoriteVideo" className="btn btn-outline-light border-0 rounded-3 d-flex align-items-center">
                <span className="material-symbols-outlined fs-7 me-3">movie</span>
                <span>收藏影音</span>
              </NavLink>
            </li>
            <li className="mb-3">
              <NavLink to="/personalCenter/viewRecords" className="btn btn-outline-light border-0 rounded-3 d-flex align-items-center">
                <span className="material-symbols-outlined fs-7 me-3">subscriptions</span>
                <span>觀看紀錄</span>
              </NavLink>
            </li>
            <li className="mb-3">
              <NavLink to="/" className="btn btn-outline-light border-0 rounded-3 d-flex align-items-center">
                <span className="material-symbols-outlined fs-7 me-3">exit_to_app</span>
                <span>返回首頁</span>
              </NavLink>
            </li>
